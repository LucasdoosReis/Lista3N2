...
package ex2.aplicacao;
import ex2.entidades.Estaduais;
import ex2.entidades.Importado;
import ex2.entidades.Nacional;
...
public class Menu {
    ...
    public static void main(String[] args) {
        ...
        List<Estaduais> estadual = new ArrayList<>();
        ...
        do {
            ...
            switch (opcao) {
                case 1:
                    ...
                    Estaduais produto = new Estaduais(descricao, valor);
                ...
                case 4:
                    ...
                    for (Estaduais exibirProdutoEstadual : estadual) {
